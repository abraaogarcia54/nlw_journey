...
export default function Trip() {
  //LOADING
  const [isLoadingTrip, setIsLoadindTrip] = useState(true);
  ...
  async function handleUpdateTrip() {
    try {
      ...
      if (!destination || !selectedDates.startsAt || !selectedDates.endsAt) {
        return Alert.alert(
          "Atualizar viagem",
          "Lembre de, além de preencher o destino, selecionar data de inicio e fim da viagem."
        );
      }
  ...
  async function handleConfirmAttendance() {
    try {
      ...
      Alert.alert("Confirmção", "Vigem confirmada com sucesso!");
  ...
  return (
    <View className="flex-1 px-5 pt-20">
      ...
      <View className="w-full absolute bottom-5 self-center justify-end pb-5 z-10 bg-zinc-950">
      ...
      >
        <View className="gap-4 mt-4">
          <Text className="text-zinc-400 font-regular leading-6 my-2">
            Voce foi convidado (a) para participar de uma viagem para
